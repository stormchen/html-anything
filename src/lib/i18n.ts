...
const en: Dict = {
  ...
  "settings.language.note":
    "We ship English, Simplified Chinese, and Traditional Chinese today. Adding a locale means dropping a dictionary into src/lib/i18n.ts — contributors welcome.",
...
const zhCN: Dict = {
  ...
  "settings.language.note":
    "目前發布的是 English、簡體中文與繁體中文。增加一種語言只需要在 src/lib/i18n.ts 裡加一份字典 — 歡迎貢獻。",
...
const zhTW: Dict = {
  ...
  "toolbar.selectAgent": "選擇 agent",
  "toolbar.switchAgent": "切換 agent",
  "toolbar.settings": "設定",
  "toolbar.stop": "◼ 停止",
  "toolbar.convert": "⚡ 轉換為 HTML",
  "convertChip.label": "生成 HTML",
  "convertChip.tooltip": "將左側 Markdown 內容轉為 HTML",
  "aiPrompt.placeholder": "讓 AI 幫你寫 Markdown — 「寫一則關於 X 的推文」、「總結上方內容」…",
  "aiPrompt.submit": "✨ 生成",
  "aiPrompt.stop": "◼ 停止",
  "aiPrompt.needAgent": "請先在右上角選擇 agent",
  "aiPrompt.hint": "結果會追加至現有內容下方。按 ⌘+Enter 送出。",
  "toolbar.firstSelectAgent": "請先選擇 agent",
  "toolbar.unsupportedProtocol": "ACP / pi-rpc 協定尚未整合，請更換 agent",
  "toolbar.enterContent": "輸入或上傳內容",
  "toolbar.shortcutHint": "⌘+Enter 轉換",

  "layout.aria.group": "工作區版面配置",
  "layout.label.editor": "僅編輯器",
  "layout.label.split": "並排 (編輯器 + 預覽)",
  "layout.label.preview": "僅預覽",
  "layout.tip.editor": "僅編輯器 — 隱藏預覽",
  "layout.tip.split": "並排 — 同時顯示編輯器與預覽",
  "layout.tip.preview": "僅預覽 — 隱藏編輯器",

  "welcome.eyebrow": "Choose your agent",
  "welcome.titlePart1": "選擇本地",
  "welcome.titleAccent": "code agent",
  "welcome.description":
    "HTML Anything 會共用你已登入的 CLI session — 不需再次輸入 API Key。進入主畫面後，隨時可在上方欄位切換 agent。",
  "welcome.rescan": "↻ 重新檢測",
  "welcome.scanning": "掃描中…",
  "welcome.rescanTitle": "重新執行檢測",
  "welcome.detectionFailed": "檢測失敗",
  "welcome.installed": "已安裝 ({n})",
  "welcome.notInstalled": "未安裝 ({n})",
  "welcome.noAgentsTitle": "未偵測到本地 agent",
  "welcome.noAgentsBody": "請先安裝上方任一 CLI 並登入，再點擊 ↻ 重新檢測。",
  "welcome.later": "稍後再說",
  "welcome.enter": "進入編輯器 →",
  "welcome.current": "目前使用",
  "welcome.unsupportedHint": "協定尚未整合，無法轉換",
  "welcome.pickInstalled": "請先選擇已安裝的 agent",
  "welcome.enterTooltip.noAgent": "請先選擇已安裝的 agent",
  "welcome.enterTooltip.unsupported": "ACP / pi-rpc 協定尚未整合，請選擇其他 agent",
  "welcome.enterTooltip.ok": "開啟編輯器",

  "model.eyebrow": "model",
  "model.label": "為 {agent} 選擇模型",
  "model.defaultHint.prefix": "選擇 Default 時不會傳送 ",
  "model.defaultHint.suffix": "，由 CLI 自行選擇",
  "model.defaultLabel": "預設 (CLI 設定)",

  "agent.selected": "SELECTED",
  "agent.notInstalled": "未安裝",
  "agent.customBin.eyebrow": "自訂路徑",
  "agent.customBin.subtitle": "手動指定 {agent} 的執行檔路徑",
  "agent.customBin.detected": "自動偵測到：",
  "agent.customBin.hint": "若自動偵測抓錯了執行檔（例如 Windows Scoop / 自訂安裝），請在此填入絕對路徑。留空則使用自動偵測。",
  ...
  "protocol.argv": "positional argv",
  "protocol.argvMessage": "argv · 整段 JSON",
  "protocol.acp": "ACP JSON-RPC · 尚未整合",
  "protocol.piRpc": "pi-rpc · 尚未整合",

  "settings.eyebrow": "設定",
  "settings.titlePart1": "設定",
  "settings.titleAccent": "HTML Anything",
  "settings.close": "關閉 (Esc)",
  "settings.done": "完成",
  "settings.section.agent.label": "Agent",
  "settings.section.agent.hint": "本地 CLI · 模型",
  "settings.section.language.label": "語言",
  "settings.section.language.hint": "介面語言",
  "settings.agent.title": "Code agent",
  "settings.agent.subtitle":
    "HTML Anything 會複用你已登入的 CLI session — 不需要再次輸入 API Key。",
  "settings.language.title": "介面語言",
  "settings.language.subtitle":
    "選擇 app 介面使用的語言。預設為 English；你的選擇將儲存於本地。",
  "settings.language.active": "目前使用",
  "settings.language.default": "預設",
  "settings.language.note":
    "目前提供 English、簡體中文與繁體中文。增加新語言只需在 src/lib/i18n.ts 加入字典 — 歡迎貢獻。",
  "settings.section.deploy.label": "部署",
  "settings.section.deploy.hint": "一鍵發布",
  "settings.deploy.title": "一鍵部署",
  "settings.deploy.subtitle":
    "將生成的 HTML 一鍵發布為公開連結。Token 僅儲存於本地 ~/.html-anything (chmod 600)。",
  "settings.deploy.vercel.title": "Vercel",
  "settings.deploy.vercel.tokenLabel": "API Token",
  "settings.deploy.vercel.tokenPlaceholder": "vercel_xxx…",
  "settings.deploy.vercel.tokenHint":
  ...
  "deploy.deploying": "部署中…",
  "deploy.success.label": "已發布至",
  "deploy.success.copy": "複製",
  "deploy.success.copied": "已複製",
  "deploy.success.open": "開啟",
  "deploy.protected.label": "已部署 (SSO 保護中)",
  "deploy.protected.hint":
    "Vercel 預設對預覽部署啟用 SSO 保護。請先開啟連結登入一次，或在 Vercel 專案設定中的 Deployment Protection 關閉此功能。",
  "deploy.delayed.label": "已部署 (CDN 同步中)",
  "deploy.delayed.hint":
    "連結已生成但 CDN 尚未完全同步，請於 30–60 秒後再試。",
  "deploy.error.label": "部署失敗",
  "deploy.error.tokenMissing": "未設定 Token。請前往 設定 → 部署 進行新增。",
  "deploy.history.title": "歷史部署",
  "deploy.history.delete": "刪除紀錄",
  "deploy.provider.vercel": "Vercel",
  "deploy.provider.cloudflarePages": "Cloudflare Pages",
  ...
  "editor.tab.samples": "✨ 範例",
  "editor.tab.formats": "📋 格式",
  "editor.attach": "附加檔案",
  "editor.attachTooltip": "拖放檔案或點擊此處上傳 — 內容將接續在編輯器末端",
  "editor.dropTitle": "放開以附加內容",
  "editor.dropHint": ".md .txt .pdf .csv .tsv .xlsx .json .sql .yaml .png .jpg — 內容將接續在編輯器末端",
  "editor.backup": "⤓ 備份",
  "editor.backupTooltip": "將目前內容下載為 .md / .txt 備份檔案",
  "editor.restoring": "正在還原上次內容…",
  "editor.placeholder":
    "在此貼上任何內容 — Markdown / CSV / Excel 貼上內容 / JSON / SQL / 你的草稿…\n\n按 ⌘+Enter 進行轉換\n\n所有輸入將自動儲存於 localStorage，重新整理頁面也不會遺失；點擊右上角 ↶ 歷史紀錄 可查看最近 8 個版本。",
  "editor.chars": "{n} 字",
  "editor.saving": "正在儲存…",
  "editor.saveFailed": "✗ 儲存失敗",
  "editor.autosaved": "已自動儲存",
  "editor.autosaveTooltip": "內容已存入瀏覽器 localStorage，重新整理不遺失",

  "preview.tab.preview": "👁 預覽",
  "preview.tab.deck": "🎬 簡報",
  "preview.tab.code": "</> 原始碼",
  "preview.tab.log": "📋 日誌",
  "preview.status.idle": "待機",
  "preview.status.running": "生成中",
  "preview.status.done": "完成",
  "preview.status.error": "錯誤",
  "preview.code.waiting": "// 等待 agent 傳回內容…",
  "preview.code.empty": "// 尚無內容",
  "preview.code.editHint": "可編輯 — 修改將即時儲存，切換至預覽 (或點擊重新整理) 即可查看效果。",
  "preview.code.lockedHint": "Agent 正在串流輸出內容，目前為唯讀狀態。",
  "preview.placeholder.runningTitle.part1": "agent 正在",
  "preview.placeholder.runningTitle.accent": "思考",
  "preview.placeholder.idleTitle.part1": "將內容貼在左側，然後點擊",
  "preview.placeholder.idleTitle.accent": "⚡",
  ...
  "preview.placeholder.chip.poster": "🖼️ 海報",
  "preview.placeholder.chip.xiaohongshu": "📱 小紅書",
  "preview.placeholder.chip.twitterCard": "🐦 推特卡",
  "preview.placeholder.chip.webProto": "🛠️ Web 原型",
  "preview.placeholder.chip.dataReport": "📊 數據報告",
  "preview.log.empty":
    "在此會即時顯示 agent 事件 (start / delta / meta / stderr / done) 與耗時統計。",
  "preview.metric.ttfbHint": "首位元組延遲 (TTFB)",
  "preview.present": "⛶ 全螢幕",
  "preview.exitPresent": "退出全螢幕",
  "preview.presentTooltip": "全螢幕預覽 — F 鍵切換 / ESC 鍵退出",
  "preview.refresh": "重新整理",
  "preview.refreshTooltip": "以目前 HTML 重新渲染預覽 iframe",

  "deck.empty": "本次生成結果中未偵測到投影片。",
  "deck.prev": "上一頁",
  "deck.next": "下一頁",
  "deck.present": "▶ 播放",
  "deck.exitPresent": "退出播放",
  "deck.presentTooltip": "全螢幕播放 — F 鍵切換 / ESC 鍵退出",
  "deck.notes": "備註",
  "deck.notesTooltip": "切換講者備註 (N)",
  "deck.slideN": "{n} / {m}",

  "tasks.heading": "任務",
  "tasks.expand": "展開任務列表",
  "tasks.collapse": "折疊任務列表",
  "tasks.newTask": "＋ 新增任務",
  "tasks.search.placeholder": "搜尋任務名稱 / 內容 / 模板…",
  "tasks.search.clear": "清除搜尋",
  "tasks.empty.intro": "沒有符合「{query}」的任務",
  "tasks.empty.clear": "清除搜尋",
  "tasks.footer": "所有任務的輸入與輸出都會自動儲存於瀏覽器，重新整理後依然保留。",
  "tasks.status.idle": "待機",
  "tasks.status.running": "生成中",
  "tasks.status.done": "完成",
  "tasks.status.error": "錯誤",
  "tasks.rename": "重新命名",
  "tasks.duplicate": "製作副本",
  "tasks.delete": "刪除任務",
  "tasks.deleteConfirm": "確定要刪除任務「{name}」嗎？該任務的輸入與生成結果都將遺失。",
  "tasks.renameDblHint": "連點兩下以重新命名",
  "tasks.emptyContent": "空白",
  "tasks.defaultName": "任務 {n}",
  ...
  "export.action.downloadHtml": ".html 單一檔案",
  "export.action.downloadPng": ".png 高清圖",
  ...
  "export.toast.htmlSaved": "已下載 HTML",
  "export.toast.imgSaved": "已下載圖片",
  ...
  "drafts.button": "↶ 歷史",
  "drafts.tooltip": "查看自動儲存的版本歷史",
  "drafts.heading": "自動儲存的版本",
  "drafts.count": "{n} 個",
  "drafts.empty.title": "暫無歷史版本",
  "drafts.empty.hint": "輸入內容超過 20 字，每 30 秒自動建立快照",
  "drafts.restoreConfirm": "還原至 {when} 的版本？目前的內容將被取代 (新版本也會自動備份)。",
  "drafts.restoredLog": "已還原 {when} 的版本 ({n} 字)",
  "drafts.delete": "刪除此版本",
  "drafts.chars": "{n} 字",
  "drafts.emptyPreview": "(空)",

  "upload.loadedLog": "已載入 {name} ({fmt})",
  "upload.failedLog": "解析失敗：{err}",

  "formats.eyebrow": "格式範例",
  "formats.subtitle":
    "一鍵載入各類輸入格式的範例片段。請先在頂端選擇模板，點擊「載入」，再按 ⌘+Enter — 輸出樣式由上方模板決定。",
  "formats.loadButton": "✨ 載入 →",
  "formats.loadedLog": "已載入 {name} ({fmt})",

  "samples.eyebrow": "範例藝廊",
  "samples.subtitle.preRendered": "預先渲染",
  "samples.subtitle.diff": "diff 編輯",
  "samples.subtitle.body":
    "每個範例都內建了 {preRendered} 世界級 HTML — 點擊即可在新任務中預覽；修改內容後按 ⌘+Enter，agent 僅執行 {diff}，節省 token 消耗。",
  "samples.filter.all": "全部",
  "samples.loading": "正在載入範例…",
  "samples.loaded": "✓ 已載入",
  "samples.loadingButton": "載入中…",
  "samples.loadButton": "✨ 載入並預覽 →",
  "samples.loadedTooltip": "此範例已在某個任務中被載入",
  "samples.sourceLink": "原文 · {label}",

  "template.loading": "載入模板…",
  "template.heading": "選擇輸出形態",
  "template.search.placeholder": "搜尋模板名稱 / 描述 / 標籤…",
  "template.search.clear": "清空",
  "template.filter.all": "全部",
  "template.filter.featured": "★ 推薦 · Featured",
  "template.featured.symbol": "★",
  "template.empty.loading": "正在載入模板…",
  "template.empty.noMatch": "找不到符合的模板。請嘗試其他關鍵字或切換分類。",
  "template.footer.hint.search": "⌕ 搜尋",
  "template.footer.hint.filter": "類別篩選",
  "template.footer.hint.hover": "懸停以檢視縮圖預覽",
  "template.footer.hint.preview": "「預覽」按鈕可將內容載入編輯器",
  "template.footer.esc": "關閉",
  "template.preview.button": "預覽",
  "template.preview.loadingButton": "…",
  "template.preview.tooltip": "將預覽快照載入至新任務",
  "template.popover.loading": "正在載入預覽…",
  "template.popover.loadInto": "載入至編輯器 →",
  "template.popover.loadIntoTooltip": "將預覽快照載入至新任務",
  "template.source.tooltip": "參考開源專案：{label}",
  "template.scenario.marketing": "行銷 / 內容",
  "template.scenario.engineering": "工程 / 開發",
  "template.scenario.operations": "營運 / 協作",
  "template.scenario.product": "產品",
  "template.scenario.design": "設計 / 探索",
  "template.scenario.finance": "財務 / 數據",
  "template.scenario.sales": "銷售",
  "template.scenario.hr": "HR / 入職",
  "template.scenario.personal": "個人 / 生活",
  "template.scenario.education": "教育 / 學習",
  "template.scenario.creator": "創作者",
  "template.scenario.video": "影片",
};
