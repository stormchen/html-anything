...
const zhTW: Dict = {
  ...
  "aiPrompt.hint": "結果會追加至現有內容下方。按 ⌘+Enter 發送。",
  ...
  "welcome.titleAccent": "code agent",
  "welcome.description":
    "HTML Anything 會複用你已登入的 CLI session — 不需要再次輸入 API Key。進入主介面後，你可以隨時在頂端欄位切換 agent。",
  "welcome.rescan": "↻ 重新檢測",
  ...
  "agent.customBin.eyebrow": "自定義路徑",
  "agent.customBin.subtitle": "手動指定 {agent} 的二進位路徑",
